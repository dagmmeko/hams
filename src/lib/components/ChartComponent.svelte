<script lang="ts">
  ...
  type ChartConfigType = 'bookings' | 'unitStatus' | 'employeeType' | 'taskStatus' | 'attendance' | 'revenue' | 'utility' | 'maintenance';
  ...
  const chartConfigs = {
    bookings: {
      ...
      colors: {
        bg: ['#F7464A', '#46BFBD', '#FDB45C', '#949FB1', '#4D5360', '#AC64AD', '#123456', '#654321'],
        hover: ['#FF5A5E', '#5AD3D1', '#FFC870', '#A8B3C5', '#616774', '#DA92DB', '#789ABC', '#CBA987']
      }
    },
    unitStatus: {
