...
type LayoutRouteId = RouteId | "/" | "/auth" | "/auth/signup-error" | "/employees" | "/employees/[employeeId]" | "/employees/add-employee" | "/roles" | "/roles/[roleId]" | "/roles/add-role" | "/tenants" | null
type LayoutParams = RouteParams & { employeeId?: string,roleId?: string }
