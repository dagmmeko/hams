...
import { u as set_current_component, r as run_all, w as current_component, x as get_store_value, o as onDestroy } from "./ssr.js";
import { s as splitPath, t as traversePath, S as SuperFormError, m as mapErrors, e as errorShape, a as traversePathsAsync, b as traversePaths, c as setPaths, d as clone$1, f as clearErrors, i as isInvalidPath, p as parse, g as mergePath, h as comparePaths, j as flattenErrors, k as pathExists } from "./errors.js";
...
function formEnhance(formEl, submitting, delayed, timeout, errs, Form_updateFromActionResult, options, data, message, enableTaintedForm, formEvents, formId, constraints, tainted, lastChanges, Context_findValidationForms, posted) {
  ...
  return enhance(formEl, async (submit) => {
    ...
    if (cancelled) {
      ...
      const validation = await clientValidation(formEl.noValidate || (submit.submitter instanceof HTMLButtonElement || submit.submitter instanceof HTMLInputElement) && submit.submitter.formNoValidate ? void 0 : options.validators, get_store_value(data), get_store_value(formId), get_store_value(constraints), get_store_value(posted));
      if (!validation.valid) {
        cancel(false);
        const result = {
          type: "failure",
