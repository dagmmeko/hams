...
declare module '$env/static/private' {
	...
	export const S3_SECRETE_KEY: string;
	...
	export const npm_package_devDependencies_aws_sdk: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_devDependencies_aws_sdk: string;
